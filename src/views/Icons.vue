...
const iconSets = [
  {
    ...
    prefix: 'mdi',
    icons: [
      'home', 'account', 'cog', 'bell', 'heart', 'star',
      'search', 'menu', 'close', 'check', 'plus', 'minus',
  ...
  },
  {
    ...
    prefix: 'heroicons',
    icons: [
      'home', 'user', 'cog-6-tooth', 'bell', 'heart', 'star',
      'magnifying-glass', 'bars-3', 'x-mark', 'check', 'plus', 'minus',
    ],
  },
  {
    name: 'Lucide',
    prefix: 'lucide',
    icons: [
      'home', 'user', 'settings', 'bell', 'heart', 'star',
      'search', 'menu', 'x', 'check', 'plus', 'minus',
    ],
  },
]
